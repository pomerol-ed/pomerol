...
elseif(POMEROL_BUILD_SHARED AND NOT POMEROL_BUILD_STATIC)
    message(STATUS "Building shared libraries")
    set(${PROJECT_CAPNAME}_BUILD_TYPE SHARED)
    set(BUILD_SHARED_LIBS ON)
else()
    message(FATAL_ERROR "Please choose EITHER POMEROL_BUILD_STATIC OR POMEROL_BUILD_SHARED type of building libraries, NOT both")
endif()
...
macro(add_progs)
  foreach(src_ ${ARGV})
    ...
    add_executable(${prog_name} "${src_}.cpp")
