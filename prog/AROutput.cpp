...
void saveChi(const char *fname, IndexClassification& IndexInfo, TwoParticleGFContainer &Chi, int size_wg) 
{
...
void saveGamma(const char *fname, Vertex4 &Vertex,  IndexClassification& IndexInfo, std::vector<TwoParticleGFContainer::IndexCombination*>& Combinations, int size_wg, unsigned short style = Amputated) 
{
...
int main(int argc, char *argv[])
{
 ...
 //   cout << std::setprecision(9) << G(1) << endl;
  ...
  if (1==1){
    ...
    saveGamma("Gamma4.dat",Gamma4,IndexInfo,v1,wn,Amputated);
