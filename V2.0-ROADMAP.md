...
- [x] Add missing Doxygen comments and update the outdated ones.

- [x] Port the tutorial and make sure the documentation is up-to-date and
      properly built.

- [x] Decide whether we want to require *libcommute* as an external
      dependency, or to bundle in to the sources / add it as a git submodule
      (decided: External dependency).
