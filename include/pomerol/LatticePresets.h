...
const Site sSite (std::string(""), 1, 2);
const Site t2gSite (std::string(""), 3, 2);
const Site egSite (std::string(""), 2, 2);

/** This is a set of presets of different Terms, most commonly used while writing a Hamiltonian. */
template<bool Complex>
class Lattice<Complex>::Term::Presets{
private:
public:
     ...
     */
    static Term* Hopping     ( const std::string& Label1, const std::string& Label2, MelemT Value, unsigned short orbital1, unsigned short orbital2, unsigned short spin1 , unsigned short spin2);

    /** A shortcut to hopping Lattice::Term \f$ t c^{\dagger}_{i\alpha\sigma}c_{j\alpha\sigma}, j \neq i \f$ */
    static Term* Hopping     ( const std::string& Label1, const std::string& Label2, MelemT Value, unsigned short orbital, unsigned short spin);
     ...
     */
    static Term* Level       ( const std::string& Label, MelemT Value, unsigned short orbital, unsigned short spin);
     ...
     */
    static Term* NupNdown    ( const std::string& Label1, const std::string& Label2, MelemT Value, unsigned short orbital1, unsigned short orbital2, unsigned short spin1, unsigned short spin2);

    /** A shortcut to Pomerol::Lattice::Term::Presets::NupNdown \f$ U n_{i\alpha\uparrow}n_{j\alpha'\downarrow'} \f$ term for \f$i=j\f$. */
    static Term* NupNdown    ( const std::string& Label, MelemT Value, unsigned short orbital1, unsigned short orbital2, unsigned short spin1, unsigned short spin2);
    ...
    static Term* NupNdown    ( const std::string& Label, MelemT Value, unsigned short orbital1, unsigned short orbital2);
    ...
    static Term* NupNdown    ( const std::string& Label, MelemT Value, unsigned short orbital, unsigned short spin1 = up, unsigned short spin2 = down);
     ...
     */
    static Term* Spinflip ( const std::string& Label, MelemT Value, unsigned short orbital1, unsigned short orbital2, unsigned short spin1 = up, unsigned short spin2 = down);
     ...
     * \param[in] spin2 \f$\sigma'\f$ - second affected spin component. By default set to \f$\downarrow\f$.
     */
    static Term* PairHopping (const std::string& Label, MelemT Value, unsigned short orbital1, unsigned short orbital2, unsigned short spin1 = up, unsigned short spin2 = down);


    static Term* SplusSminus ( const std::string& label1, const std::string& label2, MelemT Value, unsigned short orbital);
    static Term* SminusSplus ( const std::string& label1, const std::string& label2, MelemT Value, unsigned short orbital);
...
extern template class Lattice<false>::Term::Presets;
extern template class Lattice<true>::Term::Presets;
...
public:
     ...
     */
    template<bool Complex>
    static void addCoulombS(Lattice<Complex> *L, const std::string& label, MelemType<Complex> U, MelemType<Complex> Level);
     ...
     */
    template<bool Complex>
    static void addCoulombP(Lattice<Complex> *L, const std::string& label, MelemType<Complex> U, MelemType<Complex> U_p, MelemType<Complex> J, MelemType<Complex> Level);
    /** A shortcut to Lattice::Presets::addPSite with \f$U'=U-2J\f$, i.e. U_p = U - 2.0* J */
    template<bool Complex>
    static void addCoulombP(Lattice<Complex> *L, const std::string& label, MelemType<Complex> U, MelemType<Complex> J, MelemType<Complex> Level);
     ...
     */
    template<bool Complex>
    static void addMagnetization(Lattice<Complex> *L, const std::string& label, MelemType<Complex> Magnetization);
     ...
     */
    template<bool Complex>
    static void addLevel (Lattice<Complex> *L, const std::string& label, MelemType<Complex> Level);
     ...
     */
    template<bool Complex>
    static void addSzSz (Lattice<Complex> *L, const std::string& Label1, const std::string& Label2, MelemType<Complex> ExchJ);
     ...
     */
    template<bool Complex>
    static void addSS (Lattice<Complex> *L, const std::string& Label1, const std::string& Label2, MelemType<Complex> ExchJ);
     ...
     */
    template<bool Complex>
    static void addHopping (Lattice<Complex> *L, const std::string &label1, const std::string& label2, MelemType<Complex> t, unsigned short Orbital1, unsigned short Orbital2, unsigned short spin1, unsigned short spin2 );
    /** A shortcut to addHopping \f$ t c^{\dagger}_{i\alpha\sigma}c_{j\alpha\sigma} \f$ */
    template<bool Complex>
    static void addHopping (Lattice<Complex> *L, const std::string &label1, const std::string& label2, MelemType<Complex> t, unsigned short Orbital1, unsigned short Orbital2, unsigned short spin );
    /** A shortcut to addHopping \f$ \sum_{\sigma} t c^{\dagger}_{i\alpha\sigma}c_{j\alpha\sigma} \f$ */
    template<bool Complex>
    static void addHopping (Lattice<Complex> *L, const std::string &label1, const std::string& label2, MelemType<Complex> t, unsigned short Orbital1, unsigned short Orbital2 );
    /** A shortcut to addHopping \f$ \sum_{\sigma\alpha} t c^{\dagger}_{i\alpha\sigma}c_{j\alpha\sigma} \f$ */
    template<bool Complex>
    static void addHopping (Lattice<Complex> *L, const std::string &label1, const std::string& label2, MelemType<Complex> t );
};

// External templates: Real case

extern template void LatticePresets::addCoulombS(Lattice<false> *, const std::string&, RealType, RealType);
extern template void LatticePresets::addCoulombP(Lattice<false> *, const std::string&, RealType, RealType, RealType, RealType);
extern template void LatticePresets::addCoulombP(Lattice<false> *, const std::string&, RealType, RealType, RealType);
extern template void LatticePresets::addMagnetization(Lattice<false> *, const std::string&, RealType);
extern template void LatticePresets::addLevel(Lattice<false> *, const std::string&, RealType);
extern template void LatticePresets::addSzSz(Lattice<false> *, const std::string&, const std::string&, RealType);
extern template void LatticePresets::addSS(Lattice<false> *, const std::string& , const std::string&, RealType);
extern template void LatticePresets::addHopping(Lattice<false> *, const std::string &, const std::string&, RealType, unsigned short, unsigned short, unsigned short, unsigned short);
extern template void LatticePresets::addHopping(Lattice<false> *, const std::string &, const std::string&, RealType, unsigned short, unsigned short, unsigned short);
extern template void LatticePresets::addHopping(Lattice<false> *, const std::string &, const std::string&, RealType, unsigned short, unsigned short);
extern template void LatticePresets::addHopping(Lattice<false> *, const std::string&, const std::string&, RealType);

// External templates: Complex case

extern template void LatticePresets::addCoulombS(Lattice<true> *, const std::string&, ComplexType, ComplexType);
extern template void LatticePresets::addCoulombP(Lattice<true> *, const std::string&, ComplexType, ComplexType, ComplexType, ComplexType);
extern template void LatticePresets::addCoulombP(Lattice<true> *, const std::string&, ComplexType, ComplexType, ComplexType);
extern template void LatticePresets::addMagnetization(Lattice<true> *, const std::string&, ComplexType);
extern template void LatticePresets::addLevel(Lattice<true> *, const std::string&, ComplexType);
extern template void LatticePresets::addSzSz(Lattice<true> *, const std::string&, const std::string&, ComplexType);
extern template void LatticePresets::addSS(Lattice<true> *, const std::string& , const std::string&, ComplexType);
extern template void LatticePresets::addHopping(Lattice<true> *, const std::string &, const std::string&, ComplexType, unsigned short, unsigned short, unsigned short, unsigned short);
extern template void LatticePresets::addHopping(Lattice<true> *, const std::string &, const std::string&, ComplexType, unsigned short, unsigned short, unsigned short);
extern template void LatticePresets::addHopping(Lattice<true> *, const std::string &, const std::string&, ComplexType, unsigned short, unsigned short);
extern template void LatticePresets::addHopping(Lattice<true> *, const std::string&, const std::string&, ComplexType);
