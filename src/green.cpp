...
green::green(int I, int J, getStates &S_, Hamiltonian &H_, matrixs &operatorsCiCXj_, output_handle &OUT_):  i(I),j(J),S(S_), H(H_), operatorsCiCXj(operatorsCiCXj_), OUT(OUT_)			//initialization class
{
